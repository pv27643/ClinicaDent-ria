...
void main() {
  testWidgets('Buttons are visible and tappable', (WidgetTester tester) async {
    await tester.pumpWidget(const Exercicio2App());

    expect(find.text('ElevatedButton'), findsOneWidget);
    expect(find.text('FilledButton'), findsOneWidget);
    expect(find.text('FilledButton.tonal'), findsOneWidget);
